...
public class DBWrapper {
     ...
     * @param whereStmts A Map<String,String> that contains the 'keys' and 'values' in the WHERE clause. e.g. "WHERE 'key' = 'value'". Leave 'null' if no WHERE clause is needed.
     * @param joinStmts A Map<String,String> that contains 'keys' and 'values' in the JOIN clause. e.g. "JOIN key ON value". Leave 'null' if no JOIN clause is needed.
     * @return Returns the data in a CachedRowSet.
     */
     ...
     * @param attributes A String Array with the attributes from the table that is wished returned. Enter 'null' if all attributes should be returned.
     * @param table The table that is wished to retrieve data from.
     * @return Returns a String with the SQL-Statement, to the "FROM" clause.
     */
     ...
     *
     * @param joins A Map<String,String> that contains 'keys' and 'values' in the JOIN clause. e.g. "JOIN key ON value". Leave 'null' if no JOIN clause is needed.
     * @param sql The current SQL-statement that is being build.
    ...
    /**
     * This metods is only used by getRecords() to build the third part of the SQL-statement.
     * Is there no "WHERE" clause wished, this is ignored. Otherwise, it builds the "WHERE" clause on the SQL-Statement.
     * @param params A Map<String,String> that contains the 'keys' and 'values' in the WHERE clause. e.g. "WHERE 'key' = 'value'". Leave 'null' if no WHERE clause is needed.
     * @param sql The current SQL-statement that is being build.
     * @return Returns a String with the SQL-Statement, with the "WHERE" clause.
     */
    ...
    /**
     * A generic method that builds a INSERT String from the parameters that is passed to it.
     ...
     * @param values A Map<String,String> that contains 'keys' and 'values' in the INSERT clause. - "INSERT INTO (key) VALUES ("value")".
     */
     ...
     * @param values A Map<String,String> that contains 'keys' and 'values' in the INSERT clause. - "INSERT INTO (key) VALUES ("value")".
     * @return Returns a String with the SQL-Statement, with the "VALUES" clause.
     */
     ...
     * @param fields A Map<String,String> that contains 'keys' and 'values' in the UPDATE clause. - "SET 'key'='value'".
     * @param whereStmts A Map<String,String> that contains the 'keys' and 'values' in the WHERE clause. e.g. "WHERE 'key' = 'value'". Leave 'null' if no WHERE clause is needed.
     */
     ...
     * @param sql The current SQL-statement that is being build.
     * @param fields A Map<String,String> that contains 'keys' and 'values' in the UPDATE clause. - "SET 'key'='value'".
     * @return Returns a String with the SQL-Statement, with the "SET" clause.
     */
